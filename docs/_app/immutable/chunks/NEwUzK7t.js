 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zw(t){Py(Cy),br(new In("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return $w(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),Lt(Sa,Ia,t),Lt(Sa,Ia,"esm2017")}Ge.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Ge.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};zw();const et=globalThis.__sveltekit_19li2e1.env,qw={apiKey:et.PUBLIC_FIREBASE_API_KEY,authDomain:et.PUBLIC_FIREBASE_AUTH_DOMAIN,databaseURL:et.PUBLIC_FIREBASE_DATABASE_URL,projectId:et.PUBLIC_FIREBASE_PROJECT_ID,storageBucket:et.PUBLIC_FIREBASE_STORAGE_BUCKET,messagingSenderId:et.PUBLIC_FIREBASE_MESSAGING_SENDER_ID,appId:et.PUBLIC_FIREBASE_APP_ID,measurementId:et.PUBLIC_FIREBASE_MEASUREMENT_ID};let il=null,Gw=null;il=Ey().length===0?pc(qw):gc(),Gw=Vw(il);export{mC as A,pC as B,uC as a,tC as b,lC as c,rC as d,iC as e,eC as f,Zw as g,Jw as h,Xw as i,fC as j,dC as k,xp as l,hC as m,Gw as n,_C as o,oC as p,Pw as q,nC as r,sC as s,cC as t,gC as u,yC as v,vC as w,Qw as x,ec as y,Yl as z};
